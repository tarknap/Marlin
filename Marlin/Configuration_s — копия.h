...
#define CUSTOM_MACHINE_NAME "AC Kossel TRKNP_MOD"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_DIAGONAL_ROD 315       // (mm) standart 267
      // Horizontal offset from middle of printer to smooth rod center.
    #define DELTA_SMOOTH_ROD_OFFSET 181  // (mm) //standart 186
    // Horizontal offset of the universal joints on the end effector.
    #define DELTA_EFFECTOR_OFFSET 35    // (mm) //standart 31
    // Horizontal offset of the universal joints on the carriages.
    #define DELTA_CARRIAGE_OFFSET 17.75  // (mm) //standart20.6
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -0.1 } //standart -16.80
...
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST / 6) //standart /3
...
#define HOMING_FEEDRATE_Z  (75*45)
