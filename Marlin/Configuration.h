...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 316.46        // (mm)
  ...
  #define DELTA_RADIUS 140.61          // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 410 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 10000, 10000, 10000, 3000 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 6000, 6000, 6000, 600 } // ...or, set your own edit limits
#endif
...
#define HOMING_FEEDRATE_Z  (40*70)
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 0, 20 }//anycubic
  //#define NOZZLE_PARK_POINT { (X_MIN_POS + 10), 0, 20 } // standart
